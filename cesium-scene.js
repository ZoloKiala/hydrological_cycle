...
const interventions = [
  ...
  },
  {
    ...
    text: "Three types of manure promoted in the village. Materials required to make organic manure include ash, maize stoves, virgin soil, watered at intervals amd livestock manure. Targeting to make 2,000 heaps reaching out to 250 households.",
  ...
  },
  {
    ...
    text: "A demo plot where maize is intercropped with bean and mulched in an irrigation scheme. The has 165 farmers covering 18 hectares. Main crops include maize, tomato, beans and vegetables",
    enumerator: "David Munthali",
  ...
  },
  {
    ...
    text: "A total of 625 trees planted in with each farmer planting 5 trees. with 90% survival. The types of trees include Glycidia, Acadia,",
  ...
  },
  {
    ...
    text: "Visiting kambenje honey producer group. The group has 22 members with 10 male and 12 females no youth",
  ...
  },
  {
    ...
    text: "This is a demonstration plot for inter-cropping. Have planted maize and common beans. The beans aim to add nutrients to the soil. The plot is 30 m by 15 m. 300 farmers are learning from this plot.  The maize was planted on 15th May, 2026 and the beans on 29th May, 2026.",
  ...
  },
  {
    ...
    text: "Firebreak maintenance, tree planting 904 in total. Tree species include cacia, and mtangatanga",
  ...
  },
  {
    ...
    text: "Banana planting for river bank protection and check dams for land reclamation",
    enumerator: "Baxton Chirombo",
    comments: "",
  ...
  },
  {
    ...
    text: "Making an awareness of the Water and Soil Accelerator Prooject to local leaders.50 members participated 16 women and 36",
    enumerator: "Elinat Mtuoanyama",
    comments: "",
    photos: ["photos/site11-1.jpg", "photos/site11-2.jpg", "photos/site11-3.jpg"],
    pos: [-15.886059, 35.48213],
    range: 500, heading: 0, pitch: -40,
  },
  {
    icon: "D",
    category: "Erosion Control & Riparian Buffers",
    title: "VDC Meeting",
    text: "Village sensitization meeting at Gvh Nogwe 1541 attended 1123 females and 418 men",
  ...
  },
  {
    ...
    category: "Other activity",
    title: "VDC Meeting",
    text: "Making an awareness on water and soil accelerator project at GVH KAmbenje in TA NKanda",
    enumerator: "Elinat Mtupanyama",
  ...
  },
  {
    icon: "O",
    category: "Other activity",
    title: "Farmer Learning Centre",
    text: "10 different types of manure applied (Chicken droppings, cow dung, goat dung, gliricidia, pigeon peas husks, then all the above mixed with gliricidia. The plots have been planted with maize to test the manure for the famers to learn from. This is a demonstration plot measuring   1.2 hactares  with 30 members (11 men, 19 women).",
    enumerator: "Mwanjiwa Lipenga",
    comments: "Manure applied on 5th June,2026 and maize planted on 7th June,2026. The pictures shows the plots just applied and planted with maize",
    photos: [],
    pos: [-16.464245, 34.797291],
    range: 500, heading: 0, pitch: -40,
  },
  {
    icon: "O",
    category: "Other activity",
    title: "Vilkage Sensitization meeting",
    text: "Making an awareness of WASA project to community members of GVH Mbendela . 366 members attended with :206 females and 160 males/",
    enumerator: "Elinat Mtupsnyama",
    comments: "",
    photos: [],
    pos: [-15.873992, 35.489188],
    range: 500, heading: 0, pitch: -40,
  },
  {
    icon: "O",
    category: "Other activity",
    title: "Project awareness meeting",
    text: "Meeting successfully done.477  community members attended with 319 females 158 males. 36 youth and 4 PWD",
    enumerator: "Elinat Mtupabyana",
    comments: "",
    photos: [],
    pos: [-15.899805, 35.492382],
    range: 500, heading: 0, pitch: -40,
  },
  {
    icon: "B",
    category: "Conservation Agriculture",
    title: "Promotion of Velvet beans as a fertiliser crop",
    text: "Seeds were given to 50 households (1kg/hh). Two types are promoted. 0ne farmer planted the seeds in 0.4acres. Since they are climbing plants, they were planted next to trees and where cases of witch weed were high. There are cases of good leaf disposal",
    enumerator: "DAVID MUNTHALI",
    comments: "",
    photos: [],
    pos: [-15.843697, 34.818382],
    range: 500, heading: 0, pitch: -40,
  },
  {
    icon: "B",
    category: "Conservation Agriculture",
    title: "Intercropping,  mulching",
    text: "Namikoko Irrigation Scheme is located in Thilamanja EPA, Ngatala GVH, Traditional Authority Chimwala, Mangochi District. The scheme has 33 farmers, comprising 21 females, 12 males, and 3 youth, who are practicing irrigation and conservation agriculture on 5 hectares of land. They are currently growing tomatoes, vegetables, maize, and legumes. For the winter season, they will plant bean seeds (NUA 45) intercropped with maize. This follows training for 10 lead farmers in intercropping under the WASA Project. The scheme also collaborates with 35 follower farmers.",
    enumerator: "Taonga Chikoya",
    comments: "Stakeholders from Care, Mwasip and Climate-smart",
    photos: [],
    pos: [-14.64618, 35.080962],
    range: 500, heading: 0, pitch: -40,
  },
  {
    icon: "O",
    ...
    text: "Nogwe irrigation scheme  has got.1194 hacters,with 2388 women 1676, men712, youth 300 13PwD.",
    enumerator: "Elinat Mtupanyama",
    comments: "",
    photos: [],
  ...
  },
  {
    ...
    text: "40 farmers (18 f, 22m ) aare being trained in soil and water conservation.",
    enumerator: "Elinat Mtupanyama",
    comments: "Training successfully  done",
    photos: [],
    pos: [-16.0357, 35.787],
    range: 500, heading: 0, pitch: -40,
  },
  {
    icon: "O",
    category: "Other activity",
    title: "Input distribution NUA 45 beans",
    text: "50 beneficiaries received 2 kgs of beans,( 21 m ,29 f 2, pwd 0",
    enumerator: "Elinat Mtupanyama",
    comments: "",
    photos: [],
  ...
  },
  {
    ...
    category: "Conservation Agriculture",
    title: "Cover crop",
    text: "Tayamba FLC is located in TA Chowe, under GVH Nalikolo. The group has 35 lead members, comprising 33 females and 2 males, and 239 farmer followers.  On a 3.6 Ha of land. \n\nThe center is operating as a Farmer Learning Center where farmers come to find first-hand solutions to agricultural challenges.  \n\nThe members are practicing Conservation Agriculture, which includes:  \nManure making,for improving soil fertility. Legume production, to enhance soil nitrogen and nutrition  \nIntercropping with maize, to maximize land use and yields  \nCrop rotation, to maintain soil health and reduce pests  \nCrop diversification, to improve food security and income \nThrough demonstrations and practical learning, Tayamba FLC equips farmers with skills and technologies to increase productivity and build resilience to climate change.",
    enumerator: "Taonga Chikoya",
    comments: "The group is using irrigation pump which source water from the river which is nearby their scheme",
    photos: [],
    pos: [-14.551365, 35.33921],
    range: 500, heading: 0, pitch: -40,
  },
  {
    icon: "O",
    category: "Other activity",
    title: "Demonstration plot showing inter-cropping",
    text: "The demonstration plot is at GVH Chizenga. It measures 70M by 30M. Maize and common beans have been intercropped.  The plot is being managed by 30 farmers (15M,15F). Approximately 500 farmers from surrounding villages are expected to learn from the plot.",
    enumerator: "Mwanjiwa Lipenga",
    comments: "The demonstration plot activities are receiving technocal support from the area agriculture extension officer and CARD staff.",
    photos: [],
    pos: [-16.448085, 34.804692],
    range: 500, heading: 0, pitch: -40,
  },
  {
    icon: "D",
    category: "Erosion Control & Riparian Buffers",
    title: "Construction of Swallley",
    text: "Construction of 4 swalleys at Chavala which are approximately 20 metres  each. The swalleys will assist to reduce run off, maintain soli fertility in the field.",
    enumerator: "Mwanjiwa Lipenga",
    comments: "The people were capacitated on the construction of swalleys and they mobilized themselves and construct them. They reported that they think these will help reduce soil erosion in their fields considering the terrain of their fields (they are on steep slopes)",
    photos: [],
    pos: [-15.835185, 34.827387],
    range: 500, heading: 0, pitch: -40,
  },
  {
    icon: "A",
    category: "Afforestation & Agroforestry",
    title: "Establishment of a tree nursary",
    text: "A nursary has been established where species like (1,710 Mtangatanga, 200 Mahogany, 2100 Lukina, 600 pawapaw and 270 Neem) have been planted. The tree seedlings will be planted at their watershed, in homes and along river banks.",
    enumerator: "Mwanjiwa Lipenga",
    comments: "The nursary is being managed by Chavala farmer club which has a membership of 28 (12M, 16F). But the trees are expected to protect an area of about 600 hactares.",
    photos: [],
    pos: [-15.835148, 34.826822],
    range: 500, heading: 0, pitch: -40,
  },
  {
    icon: "D",
    category: "Erosion Control & Riparian Buffers",
    title: "Water tunnel",
    text: "In Nasenga Catchment, TA Mponda, GVH Chisambanopa, the 4 hotspots of Sanyira, Issa Mponda, Chisambanopa and Namakango with 427 participants, 272 female and 155 male are constructing a 7.8 km flood diversion tunnel which is 1 meter dip, and have also planted elephant grass around it, plus doing gully reclamation, swales and trenches to prevent flood water from damaging farm fields during the rainy season.",
    enumerator: "Taonga Chikoya",
    comments: "Every day beneficiaries are working \nStakeholder for Climate-smart and public works",
    photos: [],
    pos: [-14.479405, 35.177074],
    range: 500, heading: 0, pitch: -40,
  },
  {
    icon: "B",
    category: "Conservation Agriculture",
    title: "Intercropping bean Nua 45 with Maize",
    text: "In TA Mponda, GVH Chisambanopa, Village Namakango Scheme which is a 15 Ha with 400 farmers. It has  a club of 40 farmers 8 male and 32 female out of 400 farmers is practicing conservation agriculture on 2 hectares by intercropping maize with NUA 45 beans planted on 8th and 12th July, using engine pump irrigation once a week and Mbeya manure, to multiply bean seeds for sharing with 80 fellow farmers after cascading intercropping training.",
    enumerator: "Taonga Chikoya",
    comments: "Namakango has 12 Lead farmers \nManure making is on going expecting to spread 15 Ha land with Manure",
    photos: [],
...
(async function init() {
  ...
  function showStaticFallback(iv, reason) {
    if (iv.image) { mlyStatic.src = iv.image; mlyStatic.alt = iv.title; mlyStatic.hidden = false; }
    else { mlyStatic.hidden = true; }   // sites imported without a bundled photo
